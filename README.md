Genome sequencing technologies, during the last 10-15 years, have significantly reduced the cost of sequencing the genome, in 2003 the human genome was sequenced for the first time for 3 billion dollars and took 13 years, nowadays it can be done in 1 month with only 1000 dollars and its expected that in the next years this costs will drop under 100 dollars.
This has made sequencing become a tool commonly used in medicine which has led to a rapid accumulation of genomic data.
